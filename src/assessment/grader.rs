use crate::{models::{GradeResponse, QuestionRecord}, AppResult, AppState};
use uuid::Uuid;

pub async fn grade_answer(state: &AppState, question_id: Uuid, user_answer: &str) -> AppResult<GradeResponse> {
